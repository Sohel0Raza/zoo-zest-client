    ...
    <div className="my-10 md:w-10/12 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 my-10">
        <div className="w-44 h-40 mx-auto">
          <img
            className="w-full h-full p-5  md:p-3"
        ...
        <div className="w-44 h-40 mx-auto">
          <img
            className="w-full h-full p-5  md:p-3"
            src="https://i.ibb.co/sqgtNzZ/Khulshi-Mart-removebg-preview.png"
            alt=""
          />
        </div>
        <div className="w-44 h-40 mx-auto">
          <img
            className="w-full h-full p-5  md:p-3"
            src="https://i.ibb.co/LpfMY0R/unimart-removebg-preview.png"
            alt=""
          />
        </div>
        <div className="w-44 h-40 mx-auto">
          <img
            className="w-full h-full p-5  md:p-3"
            src="https://i.ibb.co/18s7Xcv/shwapno-removebg-preview.png"
            alt=""
          />
        </div>
        <div className="w-44 h-40 mx-auto">
          <img
            className="w-full h-full p-5  md:p-3"
            src="https://i.ibb.co/85sr1sG/kids-mom-removebg-preview.png"
            alt=""
          />
        </div>
      </div>
